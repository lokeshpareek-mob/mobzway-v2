...
export const metadata = {
    title: "White Label Casino Software Provider | Hire Game Developers",
    description: "Mobzway is a famous white label casino software provider company, we have professional developers to provide white label casino game solution.",
    keywords: "white label casino software, buy white label casino software, white label online casino software",
    alternates: { canonical: "https://www.mobzway.com/white-label-casino-software/" },
    openGraph: {
        title: "White Label Casino Software Provider | White Label Casino Solution",
        url: "https://www.mobzway.com/white-label-casino-software/",
        siteName: "Mobzway Technologies",
        images: [
            {
                url: "https://www.mobzway.com//assets/images/whitecasino_banner.png",
                width: 815,
                height: 821,
                alt: "white_label_casino",
                type: "image/png",
            },
        ],
    },
    twitter: {
        ...
        site: "@mobzway",
        creator: "@mobzway",
        images: ["https://www.mobzway.com//assets/images/whitecasino_banner.png"],
    },
};

export default function WhiteLabelCasinoSoftware() {
    return (
        <>
